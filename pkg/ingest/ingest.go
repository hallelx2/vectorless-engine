...
type Pipeline struct {
	...
	// Default: true (set via NewPipeline). Set to false to skip the stage
	// entirely — saves an LLM call per leaf at the cost of retrieval
	// recall on lexically-distant queries.
	HyDEEnabled bool
